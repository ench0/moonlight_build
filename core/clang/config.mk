...
CLANG_CONFIG_EXTRA_ASFLAGS := $(MOONLIGHT_CLANG_CONFIG_EXTRA_ASFLAGS)
CLANG_CONFIG_EXTRA_CFLAGS := $(MOONLIGHT_CLANG_CONFIG_EXTRA_CFLAGS)
CLANG_CONFIG_EXTRA_CPPFLAGS := $(MOONLIGHT_CLANG_CONFIG_EXTRA_CPPFLAGS)
CLANG_CONFIG_EXTRA_LDFLAGS := $(MOONLIGHT_CLANG_CONFIG_EXTRA_LDFLAGS)
...
CLANG_CONFIG_UNKNOWN_CFLAGS := \
  ...
  -fno-canonical-system-headers $(GRAPHITE_FLAGS)
...
ADDRESS_SANITIZER_RUNTIME_LIBRARY := libclang_rt.asan_$(TARGET_ARCH)_android
ADDRESS_SANITIZER_CONFIG_EXTRA_CFLAGS := -fno-sanitize=address
